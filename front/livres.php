    ...
    <main>
        <section class="book">
            <div class="book_container">
                ...
                <div class="book_box">
                    <a href="../html/livres/les_oiseaux_de_la_colere.html"><img class="book_cover"
                            src="../images/Les oiseaux de la colère.jpg" alt=""></a>
                </div>
                <div class="book_box">
                    <a href="../html/livres/un_tout_petit_peche.html"><img class="book_cover"
                            src="../images/Un tout petit péché.jpg" alt=""></a>
                </div>
                <div class="book_box">
                    <a href="../html/livres/Revin_ardennes_France.html"><img class="book_cover"
